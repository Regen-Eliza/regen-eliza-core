...
export default function Home() {
  ...
  const sendCommand = async () => {
    ...
    try {
      ...
      setLogs((prev) => [...prev, "❌ Error: Agent Offline"]);
    }
    setInput("");
  };
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 bg-slate-900 text-white">
      ...
      <div className="w-full max-w-2xl border border-slate-700 rounded-lg h-[500px] p-4 overflow-y-auto mb-4 bg-black">
        {logs.map((log, i) => (
      ...
      <div className="flex gap-4 w-full max-w-2xl">
        <input 
          ...
          placeholder="Try: 'Send 5 cUSD' or 'Roll the dice'"
          value={input}
